...
<br/> <br/> 
Deployment: [Jin Store on Netlify](https://jin-store.netlify.app/) (some features are currently unavailable in the deployed version due to an expired Commercetools subscription)  
<br/> 
Project presentation: [Presentation on Netlify](https://presentation-jin-store.netlify.app/)  
